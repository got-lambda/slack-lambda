...
get the app created:
    ...
    $ heroku apps:create slack-lambda
    Creating slack-lambda... done, stack is cedar
    http://slack-lambda.herokuapp.com/ | git@heroku.com:slack-lambda.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://slack-lambda.herokuapp.com deployed to Heroku

    To git@heroku.com:slack-lambda.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://slack-lambda.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@slack-lambda.herokuapp.com/repl
